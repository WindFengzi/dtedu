...
public class SelectItemGradeActivity extends BaseSimpleListRefreshViewActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_select_item_grade);

		TextView vTitle = (TextView) findViewById(R.id.tx_header_title);
		vTitle.setText("选择评分");

		sItemID = getIntent().getStringExtra("item_id");
		// 返回
...
//		getRightText(RIGHT_NULL);
	...
	protected void reLoadView()  {
		mHelpValue = appContext.getItemGradeList(sItemID);
	}
